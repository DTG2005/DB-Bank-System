    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="ml-64 p-8">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-2xl font-semibold">Personal Loan Application</h1>
            <p className="text-gray-600">Calculate and apply for a personal loan that fits your needs.</p>
          </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-4 pt-4 border-t">
                      ...
                      <div className="text-center p-4 bg-green-50 rounded-lg">
                        ...
                        <p className="text-xl font-bold text-green-600">{interestRate}%</p>
                      </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="p-4 border border-gray-100 rounded-lg hover:bg-gray-50 cursor-pointer">
                      ...
                      <p className="text-sm text-gray-600 mt-1">From 8.5% APR</p>
                    </div>
                    <div className="p-4 border border-gray-100 rounded-lg hover:bg-gray-50 cursor-pointer">
                      <div className="flex items-center justify-between">
                        <h4 className="font-medium">Home Loan</h4>
                        <ChevronRight className="w-5 h-5 text-gray-400" />
                      </div>
                      <p className="text-sm text-gray-600 mt-1">From 6.5% APR</p>
                    </div>
                    <div className="p-4 border border-gray-100 rounded-lg hover:bg-gray-50 cursor-pointer">
                      <div className="flex items-center justify-between">
                      ...
                      <p className="text-sm text-gray-600 mt-1">From 7.5% APR</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Recent pay stubs or tax returns</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-green-500 mt-0.5" />
